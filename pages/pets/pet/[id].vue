...
<template>
    <div class="max-lg:px-12  xl:px-16 2xl:px-28 container mx-auto pt-20">
        <div
            class="max-lg:p-8 max-lg:dark:bg-[#232d46] rounded-xl lg:py-6 flex lg:flex-row flex-col-reverse max-lg:items-center lg:justify-between gap-8 min-h-[33.1rem]">
            ...
            <aside class="rounded-lg bg-cover bg-no-repeat bg-center w-[32rem] h-[80vh] lg:h-[84vh]"
