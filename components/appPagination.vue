...
<template>
    <div class="flex items-center justify-center mt-4 gap-1">
        <button :disabled="currentPage === 1" @click="goToPage(1)"
            class="rounded-full size-[36px]  flex items-center justify-center text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-[#26304b]  transition duration-300 disabled:opacity-50 disabled:cursor-not-allowed">
